...
import { LuGithub, LuLinkedin, LuArrowRight, LuDownload } from 'react-icons/lu'
...
const Hero = () => {
  ...
  const cv_en = '/cv/cv_jeff.pdf';
  const cv_fr = '/cv/cv_jeff_fr.pdf';
